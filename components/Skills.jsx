    ...
    <section className="py-20 bg-gray-50 text-gray-900">
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10">
        ...
        <div className="bg-white shadow-md rounded-2xl border border-gray-200 p-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            <SkillCard icon={<FaPython className="text-yellow-500" />} name="Python" />
            <SkillCard
...
function SkillCard({ icon, name }) {
  return (
    <div className="flex items-center gap-2 border border-gray-200 rounded-xl p-3 hover:shadow-md transition duration-200 bg-gray-50">
