  ...
  return (
    <motion.div
      ...
      <motion.p
        ...
        className='text-center max-w-2xl mx-auto mt-5 mb-12 font-ovo'>I am a web developer from Sri Lanka, with 1 year of experience in muliple comapnies.</motion.p>
